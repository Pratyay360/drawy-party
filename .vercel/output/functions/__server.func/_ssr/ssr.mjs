...
import { a as updateSession, i as toResponse, n as clearSession, r as getSession, t as H3Event } from "../_libs/h3-v2+rou3.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dr2-hreP.mjs");
...
var manifest = {
	"1b90f4feb8175e40785b2aba78db201a0b0269327953c16d833808a1166bd7cd": {
		functionName: "logout_createServerFn_handler",
		importer: () => import("./session-vrtk7jRp.mjs")
	},
	"8fe7bbce9692fe7ceb3a35635e6520a7e1bd465714761009724ddc71260b5add": {
		functionName: "signUp_createServerFn_handler",
		importer: () => import("./session-vrtk7jRp.mjs")
	},
	"a4d3d4730f48f1e2519ac989fac8f688ba4c010085f3723244762dd3de614dca": {
		functionName: "signIn_createServerFn_handler",
		importer: () => import("./session-vrtk7jRp.mjs")
	},
	"d5e82007b47147f145f963d5be968dacdc8650b94e7b7acbccd798481667f8c2": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DxP5WpVz.mjs").then((n) => n.t),
...
//#endregion
export { getServerFnById as a, updateSession$1 as c, getRequestHeaders as i, clearSession$1 as n, getSession$1 as o, createServerFn as r, ssr_exports as s, TSS_SERVER_FUNCTION as t };
