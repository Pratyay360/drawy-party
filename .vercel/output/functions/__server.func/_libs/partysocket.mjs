...
`);
	...
	_handleClose = (event) => {
		...
		this._clearTimeouts();
		if (this._options.shouldReconnectOnClose && !this._options.shouldReconnectOnClose(event)) this._shouldReconnect = false;
...
//#endregion
//#region node_modules/partysocket/dist/index.js
