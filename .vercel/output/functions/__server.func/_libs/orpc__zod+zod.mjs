...
import { I as toArray, w as intercept } from "./@orpc/client+[...].mjs";
//#region node_modules/@orpc/zod/node_modules/zod/v4/core/registries.js
var _a;
			...
			switch (schema2._zod.def.type) {
				...
				case "object": {
					...
					if (object._zod.def.catchall) {
						if (object._zod.def.catchall._zod.def.type === "never") json.additionalProperties = false;
						else {
				...
				case "enum": {
					const values = getEnumValues(schema2._zod.def.entries);
...
function getEnumValues(entries) {
	...
	return Object.entries(entries).filter(([k, _]) => !numericValues.includes(+k)).map(([_, v]) => v);
}
//#endregion
