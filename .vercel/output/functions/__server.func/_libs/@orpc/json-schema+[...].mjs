...
import { A as overlayProxy, D as isTypescriptObject, E as isObject, F as stringifyJSON, I as toArray, M as resolveMaybeOptionalOptions, N as runWithSpan, R as value, S as findDeepMatches, T as isAsyncIteratorObject, _ as toORPCError, b as asyncIteratorWithSpan, c as HibernationEventIterator, f as createORPCErrorFromJson, g as isORPCErrorStatus, h as isORPCErrorJson, m as fallbackORPCErrorStatus, o as mapEventIterator, p as fallbackORPCErrorMessage, r as toHttpPath, s as ErrorEvent, u as ORPCError, v as NullProtoObj, w as intercept, x as clone } from "./client+[...].mjs";
import { a as mergePrefix, c as ValidationError, d as validateORPCError, i as mergeMeta, l as isContractProcedure, n as fallbackContractConfig, o as mergeRoute, r as getEventIteratorSchemaDetails, s as mergeTags, t as enhanceRoute, u as mergeErrorMap } from "../orpc__contract.mjs";
//#region node_modules/radash/dist/esm/async.mjs
...
//#endregion
//#region node_modules/@orpc/server/dist/shared/server.DEBcqOjg.mjs
...
function isAnySchema(schema) {
	...
	if (Object.keys(schema).filter((v) => schema[v] !== void 0).every((k) => !LOGIC_KEYWORDS.includes(k))) return true;
	return false;
}
...
${errors.join("\n\n")}`);
	...
	async #request(doc, ref, def, baseSchemaConvertOptions) {
		...
		if (inputStructure === "compact") {
			...
			} else if (!omitResponseBody) ref.requestBody = {
				required,
