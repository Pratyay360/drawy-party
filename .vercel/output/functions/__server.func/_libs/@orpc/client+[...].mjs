...
//#endregion
//#region node_modules/@orpc/client/dist/shared/client.CZlviB0y.mjs
...
//#endregion
//#region node_modules/@orpc/client/dist/shared/client.BtiuJPEa.mjs
		...
		for (const item of meta) {
			...
			switch (type) {
				...
				case STANDARD_RPC_JSON_SERIALIZER_BUILT_IN_TYPES.SET:
					...
					break;
				case STANDARD_RPC_JSON_SERIALIZER_BUILT_IN_TYPES.MAP: currentRef[preSegment] = new Map(currentRef[preSegment]);
			}
		}
		return ref.data;
	}
...
//#endregion
export { overlayProxy as A, get as C, isTypescriptObject as D, isObject as E, stringifyJSON as F, toArray as I, tryDecodeURIComponent as L, resolveMaybeOptionalOptions as M, runWithSpan as N, onError as O, setSpanError as P, value as R, findDeepMatches as S, isAsyncIteratorObject as T, toORPCError as _, toStandardLazyRequest as a, asyncIteratorWithSpan as b, HibernationEventIterator as c, RECURSIVE_CLIENT_UNWRAP_KEYS as d, createORPCErrorFromJson as f, isORPCErrorStatus as g, isORPCErrorJson as h, toFetchResponse as i, parseEmptyableJSON as j, once as k, flattenHeader as l, fallbackORPCErrorStatus as m, StandardRPCSerializer as n, mapEventIterator as o, fallbackORPCErrorMessage as p, toHttpPath as r, ErrorEvent as s, StandardRPCJsonSerializer as t, ORPCError as u, NullProtoObj as v, intercept as w, clone as x, ORPC_NAME as y };
