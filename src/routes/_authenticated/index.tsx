                  ...
                  <HStack justify="between" align="center" gap={2}>
                    <VStack gap={0} width="100%">
                      <HStack align="center" gap={1}>
                        ...
                        {!canvas.isOwner && <Token label={`Shared by ${canvas.owner}`} />}
                      </HStack>
                      <Text type="supporting">{formatUpdatedAt(canvas.updatedAt)}</Text>
                    </VStack>
                    {canvas.isOwner &&
            ...
            <Center>
              <VStack gap={3} hAlign="center">
                ...
                <VStack gap={1} hAlign="center">
                  ...
                  <Text type="supporting">Start sketching — changes save automatically.</Text>
                </VStack>
                <Button
