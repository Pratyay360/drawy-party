...
## partykit for realtime because it's free + nice .
...
hosted instance is not required cz (I am also on the free tier and can go off anytime on
...
2. POSTGRE ([postgresql](https://www.postgresql.org/))
